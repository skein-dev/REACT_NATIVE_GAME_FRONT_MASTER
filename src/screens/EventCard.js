...
export default class EventCard extends Component {
  constructor(props) {
    ...
    // if ( this.props.event.$__.scope.availability[0] &&  this.props.event.$__.scope.availability[0].start ) 
    // {
    //   start = new Date();
        ...
        <FlipCard
          ...
          <View style={styles.main}>
            ...
            <View style={{flex: 1, padding: 15}}>
               {/* <Image
                source={{uri: this.props.event.$__.scope ? this.props.event.$__.scope.imageUrl :""}}
                style={styles.img}
              />
              <View style={{flex: 1, marginHorizontal: 20, marginVertical: 15}}>
                <Text style={[styles.title]}>
                  {this.props.event.$__.scope ? this.props.event.$__.scope.name :""}
                </Text>
                <Text style={[styles.text2]}>
                  {this.props.event.$__.scope ? this.props.event.$__.scope.subName :""}
                </Text>
                <Text style={[styles.text2]}>
                  {this.props.event.$__.scope ? this.props.event.$__.scope.location.address :""}
                </Text>
